...
def presion_enter(evento,score,ingreso):
...
def dibujar_juego(juego_terminado,pantalla,rect_comenzar,rect_terminar,rect_respuesta_a,rect_respuesta_b,rect_respuesta_c,rect_ingreso,rect_salir):
...
def escribir_juego(juego_terminado,fuente_botones,fuente_textos,segundos,tiempo_juego,score,pantalla,imagen_estudiante,lista_ubicaciones_casillas,ubicacion,imagen_carrera_utn,posicion_carrera_utn,ingreso,rect_ingreso):
    if juego_terminado == False:
        ...
        pantalla.blit(texto_tiempo_juego,(550,550))
...
def recorrer_lista(lista_ordenada,fuente_textos,pantalla):
...
def escribir_preguntas(mostrar_preguntas,fuente_textos,lista_preguntas,lista_respuestas_a,lista_respuestas_b,lista_respuestas_c,index,pantalla):
